...
const Blog = () => (
  <div className="ModernAi__blog section__padding" id="blog">
    <div className="ModernAi__blog-heading">
      <h1 className="gradient__text">A lot is happening, <br /> We are blogging about it.</h1>
    </div>
    <div className="ModernAi__blog-container">
      <div className="ModernAi__blog-container_groupA">
        <Article imgUrl={blog01} date="Sep 26, 2021" text="GPT-3 and Open  AI is the future. Let us exlore how it is?" />
      </div>
      <div className="ModernAi__blog-container_groupB">
